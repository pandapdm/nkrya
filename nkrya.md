...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: В одном документе может быть несколько вхождений.
```
### 2. IPM
...
```
# 7.1 Прилагательные: алый, багровый, белый
```
